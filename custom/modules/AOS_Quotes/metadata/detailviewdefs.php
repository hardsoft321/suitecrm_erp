    ...
    array(
      ...
      array(
        ...
        array(
          ...
          8 =>
          array(
            'customCode' => '<input type="submit" class="button" onClick="this.form.action.value=\'createContract\'; this.form.module.value=\'AOS_ERP\';" value="{$MOD.LBL_CREATE_CONTRACT}">',
            'sugar_html' =>
            array(
              'type' => 'submit',
              ...
              array(
                ...
                'onclick' => 'this.form.action.value=\'createContract\';  this.form.module.value=\'AOS_ERP\';',
